import { ClipboardClock, Camera, Images, Wand } from "lucide-react";
...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      icon: <Images size={22} strokeWidth={1.5} />
    }
  ];

  ...
  return (
    <section className='pt-8 md:pt-14'>
      <div className='container mx-auto px-4 flex flex-col items-center justify-center flex-wrap gap-2'>
        ...
        <button className='uppercase bg-blue-800 hover:bg-linear-to-tr from-gray-500/50 via-gray-200/10 to-gray-200/30 p-2 px-3 text-xs font-medium flex items-center gap-1 border border-gray-600 cursor-pointer mt-1'> 
          Book An Appointment 
          <ArrowRight size={12} />
        </button>

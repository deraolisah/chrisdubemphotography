  ...
  return (
    <section className="py-2 md:py-4">
      <div className="container space-y-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 md:grid-rows-3 gap-2 h-300 md:h-200">
          
          {/* Item 1 - Top left */}
          <div className="col-span-1 md:col-start-1 md:row-start-1 bg-gray-400 p-2" style={{
          ...
          <div className="col-span-1 md:col-start-2 md:row-start-1 bg-gray-400 p-2" style={{
          ...
          <div className="col-span-1 md:col-start-3 md:row-start-1 bg-gray-400 p-2" style={{
          ...
          <div className="col-span-2 md:col-span-1 md:col-start-3 md:row-start-3 bg-blue-800 p-2 md:pr-6 flex items-center justify-end font-semibold text-sm md:text-2xl leading-none text-end cursor-pointer" onClick={() => { navigate("/portfolio")}}>
